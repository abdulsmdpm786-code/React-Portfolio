    ...
    <div className="container mx-auto w-10/12 p-5">
      ...
      flex flex-col xl:flex-row gap-5">
        ...
        <form action="" className="flex flex-col  gap-1">
            ...
            type="text" placeholder="Your Name..."  className=" w-60 sm:w-96 h-6 p-5  rounded-lg bg-[#bab7b2] outline-none "/><br />
            <input 
            
            type="text" placeholder="Your Email..." className="w-60 sm:w-96 h-6 p-5  rounded-lg bg-[#bab7b2] outline-none "/><br />
            <input
            
            type="text" placeholder="Your Number..." className="w-60 sm:w-96 h-6 p-5  rounded-lg bg-[#bab7b2] outline-none "/><br />
